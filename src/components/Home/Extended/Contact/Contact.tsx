...
<section className="py-6 bg-white text-gray-800">
	...
	<div className="w-full mb-16 max-w-md p-8 space-y-3 rounded-xl bg-gray-900 text-gray-100">
	...
	<p className="text-xs text-center sm:px-6 text-gray-400">Don't have an account?
		...
		<form className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
			...
			<button type="button" className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ri bg-violet-400 text-gray-100 focus:ri hover:ri">Submit</button>
		</form>
	</div>
</section>
  )
